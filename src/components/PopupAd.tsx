...
export function PopupAd() {
  ...
  return (
    <div className="fixed inset-0 z-[100] grid place-items-center overflow-y-auto p-4 bg-black/40 backdrop-blur-[2px]" onClick={close}>
      <div className="w-full max-w-full py-8" onClick={(e) => e.stopPropagation()}>
        {ad.link_url
