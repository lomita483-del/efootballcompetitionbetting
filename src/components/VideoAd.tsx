 ...
 *
 * ORIENTATION: no manual rotation is applied here. Uploaded phone/export videos
 * often carry rotation metadata (e.g. a 1280x720 frame flagged "rotate 90°
 * for playback"), and browsers already read that flag and display the video
 * right-side up automatically. Adding our own extra rotation on top of that
 * double-rotates already-corrected video, which is what produced the sideways,
 * shrunk-in-a-box look — so we just let the <video> element render as the
 * browser decodes it and let object-cover handle filling the screen.
 */
