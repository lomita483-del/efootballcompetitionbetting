 ...
 *
 * On portrait screens (phones held normally), the video is rotated 90° and
 * sized to the measured viewport so a landscape video fills the screen
 * edge-to-edge with no crop and no bars. On landscape screens (desktop, or a
 * phone turned sideways), no rotation is applied — the video just fills
 * normally since its shape already matches the screen.
 */
