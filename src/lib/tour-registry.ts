...
const TOURS: Record<string, Omit<TourDefinition, "key">> = {
  ...
  "/matches": page("Matches", "The Arena — every active fixture on the platform, with search, category filtering, live status tabs and an inline bet slip.", [
    ...
    { target: ".ecb-filter-pills", title: "Status Filters", description: "Status filters — All shows every active fixture, Live shows matches in progress and Ended shows completed match history." },
  ...
  "/dashboard": page("Dashboard", "Dashboard — your personal control room: profile, tier progress, balance, activity statistics and quick access to every account tool.", [
    ...
    { target: "[data-tour='dashboard-quick']", title: "Quick Access", description: "Quick access tiles — open your bet history, profile, withdrawals, token transfers, referrals, achievements and support in one tap." },
    ...
    { target: "[data-tour='dashboard-wallet']", title: "Wallet & Transactions", description: "Wallet and recent transactions — your token balance with the five most recent credits and debits, including the reason and time of each." },
  ]),
