import { Trophy, Medal as MedalIcon, ArrowUp, ArrowDown, Star, Users, Target, Goal } from "lucide-react";
    ...
    <Layout>
      <div className="container py-8 max-w-5xl">
        ...
        <Tabs defaultValue="gangs">
          <TabsList className="h-auto bg-black/50 backdrop-blur-[2px] border border-amber-400/40 p-1.5 gap-1.5">
            <TabsTrigger
              value="gangs"
              className="gap-1.5 rounded-lg border border-amber-400/25 px-3 py-1.5 data-[state=active]:border-amber-300/90 data-[state=active]:bg-amber-400/15 data-[state=active]:shadow-[0_0_16px_-4px_rgba(212,175,55,0.6)] data-[state=active]:text-amber-100"
            >
...
function LbRowCard({
  ...
  return (
    <div className={`grid grid-cols-[64px_1.4fr_1fr_56px_44px_44px_44px_56px_44px_60px] items-center gap-2 rounded-xl border-2 px-3.5 py-3.5 transition-colors ${rowBorder}`}>
      <div><Medal i={i} /></div>
