  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 items-start">
        ...
        {/* RIGHT: League Arena — fills the whole column so this row stays as
            compact as Broadcast Center / Live Game Stats (no more oversized
            third column forcing dead space into its siblings). */}
        <Card className="group relative min-h-[180px] overflow-hidden border-primary/30 bg-card/60">
            <img
