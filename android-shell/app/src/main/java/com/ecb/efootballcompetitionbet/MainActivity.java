...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state){super.onCreate(state);getWindow().setStatusBarColor(0xFF080808);getWindow().setNavigationBarColor(0xFF080808);
        ...
        s.setUseWideViewPort(false);s.setLoadWithOverviewMode(false);s.setLayoutAlgorithm(WebSettings.LayoutAlgorithm.NORMAL);s.setTextZoom(100);webView.setInitialScale(75);
